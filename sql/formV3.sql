...
-- ----------------------------
-- Table structure for `fp_complete_request`
-- ----------------------------
DROP TABLE IF EXISTS `fp_complete_request`;
CREATE TABLE `fp_complete_request` (
  ...
  `FP_FORM_DATA_ID` bigint(20) unsigned DEFAULT NULL,
  `NOTE` varchar(200) DEFAULT NULL,
  `STATUS` tinyint(4) NOT NULL,
  `REQUEST_DATE` date DEFAULT NULL,
  `DECISION_DATE` date DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `fp_request_unique` (`FORM_ID`,`COMPANY_ID`,`COMPANY_USER_ID`,`CONSUMER_ID`)
